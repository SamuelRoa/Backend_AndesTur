...
import staffDocumentsRoutes from "./staff_documents.routes.js";
import staffSchedulesRoutes from "./staff_schedules.routes.js";
...
router.use("/staff", staffDocumentsRoutes);
router.use("/staff", staffSchedulesRoutes);
